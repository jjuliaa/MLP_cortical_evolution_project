...
img3 = mpimg.imread('trainimg_H_x9-01.png')
print("----img shapes:----")
print(img.shape)
print(img2.shape)
print(img3.shape)
...
path = '/Users/julialc4/PycharmProjects/FFNeuralNet_Exercises/MLP_cortical_evolution_local/C++git/b2/'

h51 = h5py.File(path + 'img1coded.h5','w')
h51.create_dataset('x1', data= x1 *1.0)
h51.create_dataset('y1', data= y1 *1.0)
h51.create_dataset('c1', data= c1 *1.0)
h51.close()

h52 = h5py.File(path + 'img2coded.h5','w')
h52.create_dataset('x2', data= x2 *1.0)
h52.create_dataset('y2', data= y2 *1.0)
h52.create_dataset('c2', data= c2 *1.0)
h52.close()

h53 = h5py.File(path + 'img3coded.h5','w')
h53.create_dataset('x3', data= x3 *1.0)
h53.create_dataset('y3', data= y3 *1.0)
h53.create_dataset('c3', data= c3 *1.0)
h53.close()
